...
---------------------------------------------------------------------
function M.getSP500(csv_file)
	local r = M.read(csv_file) 
	--r = table.flatterned(r)
	local t = {}
	...
	--print(t)
	M.write('SP500.csv',{unpack(t,2,#t)})
	return t
end
function M.read(path, sep, tonum, null)
    tonum = tonum or true
    sep = sep or ','
    null = null or ''
    local csvFile = {}
...
---------------------------------------------------------------------
function M.write(path, data, sep)
    sep = sep or ','
